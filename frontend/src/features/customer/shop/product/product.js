  ...
  try {
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          <div class="flex flex-col">
              ...
              <div class="grid grid-cols-2 items-center gap-6 p-3">
              <!-- Old Price -->
              <p class="text-right text-lg md:text-xl font-bold text-gray-500 line-through">
                MRP ₹${product.price}
              </p>
              
              <!-- Discounted Price -->
              <p class="text-left text-xl md:text-2xl font-bold text-black-600">
          ...
          <div class="flex flex-col h-full">
              ...
              <div class="flex-1">
                  ...
                  <div class="mt-6 border-b border-gray-200">
                      <div class="flex flex-wrap -mb-px text-md font-medium text-center">
